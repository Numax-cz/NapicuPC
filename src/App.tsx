      ...
      <div className="container">
        <section className="section">
          <div>
            <div className="container">
              <div className="content">
                <h1 className="is-size-2 title">Můj počítač</h1>
                <p>Počítač mi slouží především na programování, úpravu fotek a videí, sledování videí a na nenáročné hraní</p>
              </div>
            </div>
          ...
          <div>
            <div className="container">
              <div className="content">
                <h1 className="is-size-2 title">Podrobnější vnitřek počítače</h1>
              </div>
            </div>
            <section className="section">
              <div>
                <h1 className="is-size-3 title">Intel Core i5-9400F</h1>
                <p>
                  Jako srdcem tohoto počítače je 6 jádrový a 6 vláknový procesor, který dosahuje 3.98GHz na
                  všech jader.
                  <br />
                  Procesor mi zvládá vše co na svou práci a zábavu potřebuji, jak programování, nenáročné hry
                  tak i virtualizaci
                </p>
              </div>
            </section>
            <section className="section">
              <div>
                <h1 className="is-size-3 title"> GeForce GT 710</h1>
                <p>
                  Na počítači si občas něco zahraji
                  Tohle dělo disponuje 1GB grafické paměti. Tato grafika mi tahá všechny hry, které potřebuji
